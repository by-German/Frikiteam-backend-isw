...
public class CreateEventStepdefs {
    ...
    public void ingresaLosDatosDelEventoYSeleccionaElBotonGuardar() {
        ...
        WebElement inputPlace = webDriver.findElement(By.xpath("//*[@id=\"mat-input-3\"]"));
        inputPlace.sendKeys("Estacion Atocongo");

        // Referencia
        WebElement inputReference = webDriver.findElement(By.xpath("//*[@id=\"mat-input-4\"]"));
        inputReference.sendKeys("Cerca del Metro-centro comercial");

        // BUSINESS INFORMATION
        // Price
        WebElement inputPrice = webDriver.findElement(By.xpath("//*[@id=\"mat-input-5\"]"));
        inputPrice.sendKeys("20");

        // Number of entries
        WebElement inputEntries = webDriver.findElement(By.xpath("//*[@id=\"mat-input-6\"]"));
